...
Class tasks {
  ...
  function __construct() {
    ...
    // temp / tasks plugin does not yet work with Files Gallery index >= 0.4.0
    if(self::$task !== 'create_html') exit('Tasks plugin does not yet work with Files Gallery index >= 0.4.0.');
