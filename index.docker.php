...
class Document      / creates the main document response
*/
...
class Config {
  ...
  public static $default = [
    'root' => '/var/www/files', // docker different
    'root_url_path' => null,
    'start_path' => false,
    'username' => '',
    'password' => '',
    ...
    'assets' => '_files/assets', // docker different
    'allow_all' => false,
    'allow_upload' => false,
    'allow_delete' => false,
    'allow_rename' => false,
  ...
  public static $version = '0.4.0';   // Files Gallery version
...
foreach (array_filter([
  ...
  'smooth-files-gallery@' . Config::$version . '/js/files.js'
...
if(U::get('action')){
  ...
  // check Files Gallery updates JSON file from jsdelivr.com repository
    ...
    $json = @json_decode(@file_get_contents('https://data.jsdelivr.com/v1/package/npm/smooth-files-gallery'), true);
  ...
  // attempt to update Files Gallery index.php to latest version via remote repository jsdelivr.com
    ...
    $get = @file_get_contents('https://cdn.jsdelivr.net/npm/smooth-files-gallery@' . $version . '/index.php');
