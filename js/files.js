/* Smooth Files Gallery 0.1.0 - https://smoothfilesgallery.soraharu.com/ */
!(function (e) {
    function t(e) {
      ...
      a: function (e, t, i) {
        return e
          ? '<a class="' +
              ...
              m(e) +
              '" data-lang="ditu amap"' +
              (i ? "" : ' title="' + X.get("ditu amap") + '"') +
              ">" +
              (i ? X.get("ditu amap") : P.get_svg_icon("marker")) +
              "</a>"
          : "";
      },
      span: function (e, t) {
    ...
    function m(e) {
      return Array.isArray(e)
        ? "https://ditu.amap.com/search?query=" + e
        : "#";
    }
    function u(e, t) {
      return e
    ...
    function v(e, t) {
      return _c.context_menu && e
        ? '<span class="context-button ' +
            t +
            '" data-action="context">' +
            P.get_svg_icon_multi("dots", "minus") +
            "</span>"
        : "";
    }
    function g(e, t, i, a) {
    ...
    function _(e, t, i) {
      ...
      var a = M(
        ...
        function (t) {
          ...
          } else if ("gps" === t) return o[i || "a"](a, "exif-item exif-gps");
          return (
            '<span class="exif-item exif-' + t + '"' + h(t) + ">" + a + "</span>"
          );
        }
      );
        ...
        var e = document.documentElement,
          t =
            window.innerWidth > e.clientWidth
              ...
              : 0;
        t
          ? t !== F.body_width && e.style.setProperty("--body-width", t + "px")
          : F.body_width && e.style.removeProperty("--body-width"),
          (F.body_width = t);
      }
    }
    var R = {
    ...
    function D(e) {
      ...
      return t && t.hasOwnProperty("preview") && !t.preview
        ? ""
        : '<img data-src="' +
            _c.script +
            (t && t.preview
              ...
              : "?preview=" + encodeURIComponent(e.path)) +
            "&" +
            _c.image_cache_hash +
            "." +
            e.mtime +
    ...
    !(function () {
      ...
      (function () {
        if (U.local_storage) {
          ...
          } else _c.menu_exists || P.clean_localstorage();
        }
      })(),
      (function () {
        U.local_storage &&
          "clear_storage" === V("action", !0) &&
          k(Object.keys(localStorage), function (e) {
        ...
        i &&
          ...
          k(t, function (e) {
            ...
            if (null !== t)
              return t === _c[e]
                ? E.remove("files:config:" + e)
                : void (_c[e] = t);
          });
      })();
    var X = (function () {
      function e(e, t) {
        return "object" == typeof files_lang && files_lang[t]
          ? Object.assign(e, files_lang[t])
          : e;
      }
      var t = !1,
        i = !1,
      ...
      "object" == typeof files_lang &&
        k(Object.keys(files_lang), function (e) {
          files_lang[e].flag && (l[e] = files_lang[e].flag);
        }),
        _c.lang_custom &&
          (k(Object.keys(_c.lang_custom), function (t) {
      ...
      var s = {},
        r = {
          ...
          dropdown: function () {
            ...
            if (e && "false" != e && "0" != e) {
              N.topbar_top.insertAdjacentHTML(
                "beforeend",
                '<div id="change-lang" class="dropdown' +
                  (t ? " dropdown-lang-loading" : "") +
                  ...
                  M(n, function (e) {
                    return (
                      ...
                      (e === g ? " dropdown-lang-active" : "") +
                      '" data-action="' +
                      e +
                      '"><img src="https://cdn.jsdelivr.net/npm/flag-icon-css@4.1.7/flags/1x1/' +
                      (l[e] || e) +
          ...
          : (function (e) {
              p(!0),
                I({
                  url: V("local")
                    ? "lang/" + e + ".json"
                    : "https://cdn.jsdelivr.net/gh/yanranxiaoxi/Smooth-Files-Gallery@" +
                      _c.version +
                      "/lang/" +
                      e +
                      ".json",
                  ...
                  complete: function (t, i, a) {
                    p(), t && i && a && (E.set("files:lang:" + e, i), m(t, e));
                  },
                  fail: function () {
                    p();
                  }
    ...
    !(function () {
      ...
      (q.plugins = {
        ...
        headroom: { src: [i + "/dist/headroom.min.js"] },
        mousetrap: { src: [a + "/mousetrap.min.js"] },
        cGF5cGFs: {
          src: [
            "https://www.paypal.com/sdk/js?client-id=" +
              (location.search.includes("sandbox")
                ? "Ad7Neqt47xP9XMR6OVhZhkKsbmsdQNel8A6fkQ2CbXHTD6jK18fS36cyzf0qiECT5fNX-fBm8tIUSLTx"
                : "Ad7Neqt47xP9XMR6OVhZhkKsbmsdQNel8A6fkQ2CbXHTD6jK18fS36cyzf0qiECT5fNX-fBm8tIUSLTx")
          ],
          type: "js"
        },
        uppy: { src: [n + "/dist/uppy.min.js", n + "/dist/uppy.min.css"] }
      }),
        ...
        "scroll" === _c.topbar_sticky &&
          getComputedStyle(N.topbar).position.match("sticky") &&
          P.load_plugin("headroom", function () {
    ...
    function K() {
      ...
      if (!a || (a != _c.qrx && S(a) != i)) {
        var n = !_c.qrx;
        return _c.qrx || n || !i || i.includes(".")
          ? !_c.qrx ||
            ("string" == typeof _c.qrx && /^[a-f0-9]{32}$/.test(_c.qrx))
            ? void I({
                params:
                  (_c.qrx ? "key=" + _c.qrx + "&" : "") +
                  (n ? "app=1&domain=" : "app=2&host=") +
                  encodeURI(i),
                url: S("aHR0cHM6Ly9zbW9vdGhmaWxlc2dhbGxlcnkuc29yYWhhcnUuY29tL2F1dGgv"),
                json_response: !0,
                complete: function (t, a, o) {
                  if (o && t && t.hasOwnProperty("status"))
                    return t.status && 301 != t.status
                      ? void (n || E.set(e, _c.qrx || btoa(i)))
                      : l(_c.qrx);
                }
              })
            : l(!0)
      ...
      function o(e, i) {
        var a,
          n =
            (e
              ? '<div class="alert alert-danger" role="alert"><strong>许可证无效</strong><br>你输入了一个无效的许可证密钥。</div>'
              : "") +
            '<div id="pay"><div id="pay_info"><strong>购买许可证 [$1]</strong> 即可解锁功能并支持我们！\t\t' +
            ...
            [
              ...
              a +=
                ...
                P.get_svg_icon("check") +
                e +
                "</div>";
            }),
            a +
              '</div><small>* 购买后，您将通过电子邮件收到 <strong>许可证密钥</strong> 。</small><br /><small>* 中国用户请 <strong><a href="mailto:purchase@soraharu.com?subject=[购买许可证]%20Smooth%20Files%20Gallery">发送邮件</a></strong> 以支付并获取许可证。</small>\t\t</div><div id="pay_pp"></div></div>\t\t<form id="license_form" novalidate>\t\t\t<input id="license_key" class="form-control" type="text" placeholder="许可证密钥" required>\t\t\t<button id="continue_free" type="button" class="btn btn-light">不，谢谢！</button>\t\t\t<button id="license_save_button" type="submit" class="btn btn-success text-light" style="display:none;">保存</button>\t\t</form>'),
          o =
            (Swal.fire({
              html: n,
              showConfirmButton: !1,
                ...
                createOrder: function (e, t) {
                  return t.order.create({
                    purchase_units: [
                      {
                        amount: { value: "1.00" },
                        description: "Smooth Files Gallery",
                        custom_id: "smooth_files_gallery"
                      }
                    ],
                    application_context: {
                      brand_name: "Smooth Files Gallery",
                ...
                onError: function (e) {
                  z("error", e),
                    (p.innerHTML =
                      ...
                      P.get_svg_icon("alert_circle_outline") +
                      "支付失败</div>");
                },
                    ...
                    i.order.capture().then(function (e) {
                      m(0),
                        (p.innerHTML =
                          ...
                          "</strong><br>" +
                          e.payer.email_address +
                          "</p><p>感谢您的购买！ 请查看邮箱获取许可证密钥。</p>"),
                        z("details", e),
                        E.set(t, !0),
                        s.focus();
                        ...
                        (s.value ||
                          (function e() {
                            I({
                              params: "txn_id=" + i,
                              url: S(
                                "aHR0cHM6Ly9zbW9vdGhmaWxlc2dhbGxlcnkuc29yYWhhcnUuY29tL2FwaXgvZ2V0TGljZW5zZUtleS5waHA="
                              ),
                              json_response: !0,
                              complete: (t, i, a) => {
                                if (t && i && a && !s.value) {
                                  if (!t.key) return setTimeout(e, 2e3);
                                  (s.value = t.key),
                                    s.dispatchEvent(
    ...
    !(function () {
        ...
        k(Object.keys(a), function (e) {
          ...
          (P.get_svg_icon_files = function (e) {
            return e.is_dir
              ...
              : P.get_svg_icon(o(e) || "file_default");
          }),
      ...
      (function () {
        ...
        var e = (function () {
          N.topbar_breadcrumbs.insertAdjacentHTML(
            "afterbegin",
            '<button id="folder-actions" class="context-button" style="display:none">' +
              P.get_svg_icon("folder_cog_outline") +
              "</button>"
          );
          var e = N.topbar_breadcrumbs.firstElementChild;
          return (
            y(e, (t) => P.create_contextmenu(t, "topbar", e, _c.current_dir)), e
          );
        })();
        function a(e, i) {
          return (
        ...
        function s() {
          ...
          n.length &&
            k(n, function (n, l) {
              (e += e ? "/" + n : n),
                (t.length || n !== o[l]) && ((s += a(e, i(n))), t.push(l + 1));
            }),
            t.length &&
              (N.breadcrumbs.insertAdjacentHTML("beforeend", s),
              l(
                (function (e, t) {
            ...
            (o = n.slice(0)),
            N.breadcrumbs.lastChild != N.breadcrumbs.firstChild &&
              N.breadcrumbs.lastChild.classList.add("crumb-active");
        }
        (N.breadcrumbs.innerHTML = a("", P.get_svg_icon("home"))),
          (P.set_breadcrumbs = function (t) {
            if (
              ...
              k(o, function (e, t) {
                (i.length || e !== n[t]) &&
                  i.unshift(N.breadcrumbs.children[t + 1]);
              }),
                i.length
                  ? l(i, !0)
                  : (N.breadcrumbs.lastChild.classList.remove("crumb-active"),
                    s());
            } else s();
          }),
          y(N.breadcrumbs, function (e) {
            "A" !== e.target.nodeName ||
              b(e, e.target) ||
              P.get_files(e.target.dataset.path, "push");
          });
      })(),
      ...
      (function () {
        ...
        var c = Object.assign(
          { javascript: !0, current_dir_only: !0 },
        ...
        (P.create_contextmenu = function (p, d, u, f, v) {
          if ((_c.context_menu || "topbar" === d) && u && f) {
            if (e.is_open) {
              if (u == e.el) return p.preventDefault();
            ...
            p.stopPropagation(),
              (u === e.el && f === e.item) ||
                (a.innerHTML =
                  ...
                  t(f.basename) +
                  '">' +
                  ("files" === d ? P.get_svg_icon_files(f) : "") +
                  i(f.basename) +
                  "</h6>" +
                  r(
                    "zoom",
                    null,
                    "popup",
                    "popup" !== d && f.browser_image && f.is_readable
                  ) +
                  r(
                    "open",
                    null,
                    "folder",
                    "sidebar" !== d && f.is_dir && f !== _c.current_dir
                  ) +
                  r("show info", null, "modal", !["modal", "popup"].includes(d)) +
                  (function (e, t) {
                    var i = !!e && s(e);
                    return i && "#" !== i
                      ? '<a class="' +
                  ...
                  r(
                    ...
                    null,
                    "clipboard",
                    U.url && U.clipboard && f.url_path
                  ) +
                  (function (e, t) {
                    return U.download && !e.is_dir && e.is_readable
                      ? '<a href="' +
                          l(e, !0) +
                          '" class="' +
                          t +
                  ...
                  (function (e) {
                    ...
                    return !i ||
                      (c.current_dir_only && i !== _c.current_dir) ||
                      ("files" === _c.download_dir &&
                        (!i.files_count || !U.is_pointer)) ||
                      (i.hasOwnProperty("files_count") && !i.files_count)
                      ? ""
                      : "zip" !== _c.download_dir || c.javascript
                      ? '<button class="dropdown-item fm-action" data-action="download_dir">' +
                        P.get_svg_icon("tray_arrow_down") +
                        X.span("download", !0) +
                        '&nbsp;<span class="no-pointer">' +
                        ("zip" === _c.download_dir ? "Zip" : X.get("files")) +
                        "</span></button>"
                      : '<a href="' +
                        n(i) +
                  ...
                  (function () {
                    if ("popup" === d || !f.is_writeable) return "";
                    var e =
                      r(
                        "delete",
                        "close_thick",
                        "delete",
                        _c.allow_delete && f.path,
                        "fm-action"
                      ) +
                      r(
                        "new folder",
            ...
            var g = u.getBoundingClientRect(),
              ...
              x = _ >= 0,
              b =
                !x && h + a.clientHeight <= document.documentElement.clientHeight;
            a.style.top = Math.round(b ? h : Math.max(0, _)) + "px";
            var y =
                (u.clientWidth > 100 ? p.clientX : g.left + u.offsetWidth / 2) -
                a.clientWidth / 2,
              w = Math.max(
                10,
                Math.min(
                  document.documentElement.clientWidth - a.clientWidth - 10,
                  y
                )
              );
            (a.style.left = Math.round(w) + "px"),
              a.style.setProperty(
                ...
                Math.round(
                  Math.max(
                    10,
                    Math.min(a.clientWidth - 10, a.clientWidth / 2 - w + y)
                  )
                ) + "px"
              ),
          ...
          d(a, function (t, i) {
            if (ae[t]) ae[t](e.item);
              ...
              Z(),
                q.uppy.setMeta({ path: e.item.path }),
                q.uppy.getPlugin("Dashboard").openModal();
            else if ("popup" === t)
              _c.history && q.modal.open && q.modal.popstate.remove(),
                P.open_popup(e.item);
            else if ("folder" === t)
              q.modal.open && P.close_modal(), P.get_files(e.item.path, "push");
            else if ("modal" === t) P.open_modal(e.item, !0);
            else if ("clipboard" === t)
              (l = s(e.item)), (r = new URL(l, location)) && x(r.href);
            else if ("download_dir" === t) {
              if (G && "zip" === _c.download_dir && !c.javascript) return;
              if ((i.preventDefault(), !G)) return te.fire();
              if ("zip" === _c.download_dir) {
                ...
                Swal.fire({
                  ...
                  customClass: { popup: "download-toast" },
                  didOpen: () => {
                    Swal.showLoading();
                    var t = Swal.getContainer().getElementsByClassName(
                        "swal2-timer-progress-bar"
                      )[0],
                      i =
                        Swal.getContainer().getElementsByClassName(
                          "swal-percent"
                        )[0];
                ...
                if (
                  ...
                  Object.keys(o).forEach((e) => {
                    ...
                    !t.is_dir &&
                      t.url_path &&
                      downloadables.push(encodeURI(t.url_path));
                  }),
                  !downloadables.length)
                )
                  return ee.fire({ title: "没有要下载的文件" });
                !(function e() {
                  new jsFileDownloader({ url: downloadables[index] }).then(
                    function () {
      ...
      (function () {
        ...
        U.is_touch && document.addEventListener("touchstart", function () {}, !0),
          (P.dropdown = function (e, t, n) {
            U.only_pointer
              ? n && y(t, n)
              : U.only_touch || !U.pointer_events
              ? y(
                  t,
                  function () {
                    a(e);
              ...
              U.is_dual_input
                ...
                : U.is_pointer && e.classList.add("mouse-hover");
          });
      })();
    var J = Swal.mixin({
        input: "text",
      ...
      te = ee.mixin({ title: S("TGljZW5zZSByZXF1aXJlZA==") }),
      ie = Swal.mixin({
        title: "确定？",
        showCloseButton: !0,
        showCancelButton: !0,
      ...
      ae = (function () {
        function e(e, t, i, o) {
          if (!ae[e]) return ee.fire({ title: e + " 不可用" });
          if (!_c["allow_" + e]) return ee.fire({ title: e + " 不允许" });
          if (_c.demo_mode) return ee.fire({ title: "在演示模式下不允许" });
          if (!G) return te.fire();
          if (
            !t.is_writeable &&
            ["delete", "rename", "new_folder", "new_file"].includes(e)
          )
            return ee.fire({ title: t.path + " 不可写" });
          var l = !!_c.files[t.basename] && q.list.get("path", t.path)[0],
            s = !!l && a(l.elm),
            r =
              !(!t.is_dir || !N.sidebar_menu) &&
              ("" === t.path
                ? N.sidebar_menu
                : a(_query('[data-path="' + n(t.path) + '"]', N.sidebar_menu))),
            c = s
              ? _c.current_dir
          ...
          I({
            ...
            complete: function (i, a, n) {
              return (
                ...
                n && i && a
                  ? i.error
                    ? ee.fire({ title: i.error })
                    : i.success
                    ? (q.contextmenu.item === t && delete q.contextmenu.el,
                      void (o && o(l, s, r, c, i)))
                    : ee.fire()
                  : ee.fire()
              );
        ...
        return {
          duplicate: function (t) {
            if (t.is_dir) return ee.fire({ title: "无法复制文件夹" });
            J.fire({
                ...
                e(
                  ...
                  function (e, t, i, a) {
                    a &&
                      ...
                      a === _c.current_dir &&
                        P.get_files(_c.current_path, "replace", !0));
                  }
                );
            });
          },
          rename: function (t) {
            J.fire({
              ...
              inputValidator: (e) => {
                ...
                var i = e.match(/[<>:"'/\\|?*#]|\.\.|\.$/g);
                if (i) return "无效字符 " + i.join(" ");
                if (
                  _c.files[t.basename] &&
                  _c.files[t.basename].path === t.path
                ) {
                  if (_c.files[e])
                    return (t.is_dir ? "Folder" : "File") + " 已存在";
                } else if (t.is_dir) {
                  var a = t.path.split("/").slice(0, -1).join("/");
                  if (_c.dirs[o(a, e)]) return "文件夹已存在";
                }
              }
            }).then((i) => {
                ...
                e("rename", t, "&name=" + encodeURI(a), function (e, i, s, r) {
                  ...
                  t.is_dir &&
                    (Object.keys(_c.dirs)
                      ...
                      .forEach(function (e) {
                        ...
                        if (
                          ...
                          s &&
                            (e === p &&
                              (s.firstElementChild.lastChild.textContent = a),
                            (s.dataset.path = i),
                    ...
                    _c.current_path &&
                      ...
                      P.get_files(_c.current_dir.path, "push"));
                });
              }
            });
          },
          new_folder: function (a) {
            if (!a.is_dir)
              return ee.fire({ title: a.basename + " 不是一个目录" });
            J.fire({
              ...
              inputValidator: (e) => {
                ...
                return t
                  ...
                  : _c.dirs[o(a.path, e)] ||
                    (_c.dirs[a.path] &&
                      _c.dirs[a.path].files &&
                      _c.dirs[a.path].files[e])
                  ? "文件夹存在"
                  : void 0;
              }
            }).then((n) => {
              if (n.isConfirmed && n.value) {
                ...
                e(
                  ...
                  function (e, n, r, c) {
                    if (
                      ($.fire({ title: s }), _c.menu_enabled && !_c.menu_exists)
                    )
          ...
          new_file: function (t) {
            if (!t.is_dir)
              return ee.fire({ title: t.basename + " 不是一个目录" });
            J.fire({
          ...
          delete: function (t) {
            ie.fire({ title: X.get("delete", !0), html: s(t.path) }).then((i) => {
              i.isConfirmed &&
                e("delete", t, null, function (e, i, a, n, o) {
                  if (o.fail)
                    return ee.fire({
                      title:
                        "无法删除 " +
                  ...
                  if (
                    ($.fire({ title: X.get("delete", !0) + " " + t.basename }),
                    ...
                    n.preview === t.basename && (delete n.preview, n.path))
                  ) {
                  ...
                  if (
                    ...
                    _c.current_path &&
                      _c.current_path.startsWith(t.path) &&
                      P.get_files(n.path, "replace");
                  }
                });
            });
          }
      ...
      P.load_plugin("uppy", function () {
        var e = (q.uppy = new Uppy.Core({
            ...
            .on("upload-success", (t, i) => {
              ...
              a && t.name !== a && e.setFileMeta(t.id, { name: a });
            })
            .on("complete", (t) => {
              t.successful &&
                t.successful.length &&
                t.successful.forEach(function (e) {
                  e.uploadURL &&
            ...
            .use(Uppy.ImageEditor, { target: Uppy.Dashboard, quality: 0.8 })),
          t = _class("uppy-Root")[0];
        function i(t, i) {
          var a = e.getPlugin("Dashboard");
          !!t !== a.isModalOpen() &&
            (a[t ? "openModal" : "closeModal"](), i && e.setMeta({ path: i }));
        }
        function a(e) {
          P.load_plugin(
            "uppy_locale_" + e,
    ...
    !(function () {
      var e = !1,
        n =
          U.pixel_ratio >= 1.5 && _c.image_resize_dimensions_retina
            ? _c.image_resize_dimensions_retina
            : _c.image_resize_dimensions;
      function r(t, i) {
        ...
        (document.title = t || "/"),
          i &&
            ...
            history[i + "State"](
              ...
              t,
              (function (e, t) {
                return p || "replace" !== e || (!_c.query_path && t)
                  ? ((p = !0),
                    t
                      ? "?" +
              ...
              if (c.mime1) {
                if ("image" === c.mime0) {
                  ...
                  if ("svg+xml" === c.browser_image || "svg" === c.ext) {
                    ...
                    "ico" === c.ext && (t += " files-img-ico"),
                      c.dimensions &&
                        ((c.preview_dimensions = e
                          ? c.ratio > 1
                            ? [e, Math.round(e / c.ratio)]
                            : [Math.round(e * c.ratio), e]
                  ...
                  return (
                    ...
                    '" data-src="' +
                    (function () {
                      if (l) return l + encodeURI(c.path);
                      ...
                      return (
                        ...
                        (e
                          ? "&resize=" + e + "&" + _c.image_cache_hash + "." + t
                          : "&" + t)
                      );
                    })() +
                    '"' +
                ...
                return "video" === c.mime0 &&
                  ...
                  ? ((c.preview_dimensions = [480, 320]),
                    (c.preview_ratio = 1.5),
                    (c.is_browser_video ? P.get_svg_icon("play") : "") +
          ...
          return (
            ...
            '<a href="' +
              ...
              (c.image && c.image.iptc && c.image.iptc.title
                ...
                : "") +
              a(P.get_svg_icon_files(c), "icon") +
              u(c.dimensions, "dimensions") +
              f(c, "size") +
              _(c.image, "exif", "span") +
              a(c.ext ? a(c.ext, "ext-inner") : "", "ext") +
              a(P.get_time(c, "ll", "llll", !1), "date") +
              '<span class="flex"></span></div>' +
              v("menu" !== _c.click || c.is_dir, "files-context") +
              D(c) +
              "</a>"
          );
        }));
      ...
      function g(e, t, i) {
        K(),
          ...
          _c.files_count &&
            ((N.files.innerHTML = _c.current_dir.html || m()),
            oe.create(),
            "push" !== t && oe.hash(!0),
            P.set_sort(),
            ("replace" === t &&
          ...
          if (!a && n) {
            ...
            if (o)
              return (
                h(t, o),
                r(!1, function () {
                  oe.empty(), g(t, i, "files from localStorage");
                })
              );
          }
          oe.disabled(!0),
            ...
            (e = I({
              ...
              complete: function (e, a, n) {
                return n
                  ? e.error
                    ? x(e.error + " " + t, t, i)
                    : (h(t, e), E.set(le(t, e.mtime), a, !1, 1e3), void c())
                  : x(t, t, i);
              }
            }));
        }
        ...
        (P.init_files = function () {
          if (_c.query_path)
            return _c.query_path_valid
              ...
              : x("Invalid directory " + _c.query_path, _c.query_path, "replace");
          if (location.search) {
        ...
        y(N.files, function (e) {
          ...
          if (t !== N.files) {
            ...
            if (a) {
              ...
              if (t.dataset.href)
                return e.preventDefault(), window.open(t.dataset.href);
              if (
                a.is_dir ||
                !(
                  "window" === _c.click ||
                ...
                (a.is_dir || "download" !== _c.click) &&
                  (b(e, i) ||
                    (e.preventDefault(),
                    a.is_dir
                      ? (h(a.path, a), P.get_files(a.path, "push"))
                      : "menu" === _c.click
                      ? P.create_contextmenu(e, "files", i, a)
      ...
      (function () {
        ...
        t.includes(_c.layout) || (_c.layout = "rows"),
          N.files.className != "list files-" + _c.layout &&
            (N.files.className = "list files-" + _c.layout);
        var i =
            getComputedStyle(N.files)
        ...
        function n() {
          N.files.style.setProperty("--imagelist-height", o ? "100px" : "100%"),
            N.files.style[(o ? "set" : "remove") + "Property"](
              ...
              (a.space = (function () {
                ...
                return !e || isNaN(e) || 50 == e
                  ...
                  : ((e = O(0, 100, e)),
                    ...
                    0 == e &&
                      N.files.style.setProperty("--" + t + "-border-radius", 0),
                    e);
              })());
          });
        var s = l(_c.layout);
        ...
        c.innerHTML =
          ...
          P.get_svg_icon("layout_" + s.layout) +
        ...
        function j(e) {
          s.layout !== e &&
            ((p.innerHTML = P.get_svg_icon("layout_" + e)),
        ...
        y(
          ...
          y(
            ...
            function (e) {
              ...
              _c.files_count > z &&
                N.files.style.setProperty("--" + s.layout + "-space-factor", t),
                N.files.style[(t > 0 ? "remove" : "set") + "Property"](
          ...
          y(
            ...
            function () {
              (a = this.checked ? "cover" : "contain") == i
                ? (N.files.style.removeProperty("--img-object-fit"),
                  E.remove("files:interface:img-object-fit"))
                : (N.files.style.setProperty("--img-object-fit", a),
      ...
      (function () {
        var e,
          ...
          o = E.get("files:popup:locked_caption"),
          s = screen.width < 375 ? "ll" : screen.width < 414 ? "lll" : "llll",
          r = screen.width >= 576,
          p = {
            caption_hide: !0,
            caption_style: "block",
            ...
            getThumbBoundsFn: function (t, i) {
              var a = e.items[t],
                n = q.modal.open
                  ? q.modal.item === a.item && _class("modal-image", N.modal)[0]
                  : a.img_el;
            ...
            addCaptionHTMLFn: function (e, a) {
              ...
              if (!N.filter.value) {
                if ("video" === e.type)
                  return (n.search.innerHTML = o.basename), c(n.caption_center);
                c(n.search);
              }
              return (
                o.hasOwnProperty("popup_caption") ||
                  (o.popup_caption =
                    v(U.PointerEvent, "popup-context") +
                    '<div class="popup-basename">' +
                    i(o.basename) +
                    "</div>" +
                    u(o.dimensions, "popup-dimensions") +
                    f(o, "popup-filesize") +
                    '<span class="popup-date">' +
                    P.get_time(o, s, "LLLL", r) +
                    "</span>" +
                    _(o.image, "popup-exif") +
                    g(o.image, "popup")),
                o.popup_caption
        ...
        function m(t) {
          var i =
            !!(n.current_video && n.is_open && e && e.itemHolders) &&
            n.current_video.firstElementChild;
          i && "VIDEO" == i.nodeName && i[t]();
        }
        function x(e) {
          m("pause"), (n.current_video = e);
        }
        function b() {
          return (
            !e.options.loop &&
        ...
        _c.config &&
          _c.config.popup &&
          (Object.assign(p, _c.config.popup),
                  ...
                  a.forEach(function (e, i) {
                    ...
                    if (a && a.is_readable && a.is_popup) {
                      if (a.browser_image) {
                        ...
                        if (
                          (r && ((p.w = a.image.height), (p.h = a.image.width)),
                          c &&
                            !p.msrc &&
                            (o.onload = function () {
                      ...
                      a === t && (s.index = n.slides.length), n.slides.push(p);
                    }
                  });
              n.slides.length &&
                (Z(),
                ...
                "topbar" !== p.caption_style &&
                  N.filter.value &&
                  (n.search.innerHTML =
                    P.get_svg_icon("image_search_outline") +
                    '"' +
                    i(N.filter.value) +
                    '"'),
                ...
                e.listen("afterChange", function () {
                  n.ui.classList.toggle(
                    "popup-ui-video",
                    "video" == e.currItem.type
                  ),
                    n.toggle_timer(!0);
                }),
                t.is_browser_video &&
                ...
                e.listen("destroy", function () {
                  ...
                  for (var e = 0; e < n.items.length; e++) c(n.items[e]);
                  c(n.search), (n.is_open = !1);
                }),
                e.init());
            }
          }),
          ...
          document.body.insertAdjacentHTML(
            "beforeend",
            '\t\t<div class="pswp' +
              (U.is_touch ? " pswp--touch" : "") +
              (U.only_pointer ? " pswp--has_mouse" : "") +
              ...
              (p.downloadEl
                ? '<a type="button" class="pswp__button pswp__button--download"' +
                  h(U.download ? "download" : "open in new tab") +
                  ' target="_blank"' +
                  (U.download ? " download" : "") +
                  ">" +
                  P.get_svg_icon(U.download ? "download" : "open_in_new") +
                  "</a>"
                : v(!0, "pswp__button pswp__button--contextmenu")) +
              (U.only_touch
                ? ""
                : '<button class="pswp__button pswp__button--zoom">' +
                  P.get_svg_icon_multi("zoom_in", "zoom_out") +
                  "</button>") +
              '\t            <button class="pswp__button pswp__button--play">' +
              P.get_svg_icon_multi("play", "pause") +
              "</button>\t            " +
              (U.fullscreen
                ? '<button class="pswp__button pswp__button--fs">' +
                  P.get_svg_icon_multi("expand", "collapse") +
                  "</button>"
                : "") +
              '\t            <button class="pswp__button pswp__button--close">' +
              P.get_svg_icon("close") +
              '</button>\t          </div>\t          <button class="pswp__button pswp__button--arrow--left">' +
              P.get_svg_icon("chevron_left") +
              '</button><button class="pswp__button pswp__button--arrow--right">' +
              P.get_svg_icon("chevron_right") +
              '</button>\t          <div class="pswp__timer"></div>\t          <div class="pswp__caption pswp__caption-style-' +
              p.caption_style +
              (p.caption_hide ? " pswp__caption-hide" : "") +
              (o ? " pswp__caption-locked" : "") +
              '">\t          \t' +
              (U.only_touch
                ? ""
                : '<button class="pswp__button pswp__button--lock-caption">' +
                  P.get_svg_icon_multi("lock_outline", "lock_open_outline") +
                  "</button>") +
          ...
          n.caption.addEventListener("click", function (t) {
            return t.target.classList.contains("pswp__button--lock-caption")
              ? ((o = !o),
                ...
                E.set("files:popup:locked_caption", o, !0))
              : "context" == t.target.dataset.action
              ? P.create_contextmenu(t, "popup", t.target, e.currItem.item)
              : void (
                  U.is_pointer &&
                  0 === t.target.className.indexOf("pswp") &&
                  ("right" === p.caption_align && t.pageX > this.clientWidth - 49
                    ? e.next()
                    : "left" === p.caption_align && t.pageX < 49 && e.prev())
                );
          }),
          U.is_pointer &&
            n.contextmenu_button &&
            y(n.contextmenu_button, function (t) {
              P.create_contextmenu(t, "popup", t.target, e.currItem.item);
            });
      })(),
      (function () {
        ...
        _c.check_updates &&
          (E.get("files:updated")
            ? (E.remove("files:updated"),
              t("✓ 已成功更新到版本 " + _c.version),
                    ...
                    if (
                      ...
                      _id("change-sort").insertAdjacentHTML(
                        ...
                        '<div id="files-notifications" class="dropdown"><button type="button" class="btn-icon btn-topbar">' +
                          ...
                          (i.writeable
                            ? '<button class="dropdown-item">' +
                              P.get_svg_icon("rotate_right") +
                              '<span class="dropdown-text" data-lang="update">' +
                              X.get("update") +
                              "</span></button>"
                            : "") +
                          (U.download
                            ? '<a href="https://cdn.jsdelivr.net/gh/yanranxiaoxi/Smooth-Files-Gallery@' +
                              o +
                              '/index.php" class="dropdown-item" download>' +
                              P.get_svg_icon("download") +
                              '<span class="dropdown-text" data-lang="download">' +
                              X.get("download") +
                              "</span></a>"
                            : "") +
                          '<a href="https://smoothfilesgallery.soraharu.com/" class="dropdown-item" target="_blank">' +
                          P.get_svg_icon("info") +
    ...
    !(function () {
      ...
      var t = N.modal.children[0],
        ...
        r = (s.lastElementChild, !!_c.allow_text_edit && s.children[0]),
        m = a.children[1];
      q.modal = {};
      var y = w(function () {
      ...
      (P.open_modal = function (n, r) {
          ...
          if (n.browser_image)
            (q.modal.type = "image"),
              ...
              (c =
                ...
                '"' +
                (!n.dimensions ||
                (!_c.server_exif && U.image_orientation) ||
                (!U.image_orientation && T(n.image))
                  ? ""
                  : ' width="' +
                    n.dimensions[0] +
                    '" height="' +
        ...
        var x =
            ["image", "file"].includes(q.modal.type) ||
            ("dir" === q.modal.type && n.url_path)
              ? "a"
              : "div",
          b =
            "<" +
            ("a" === x
              ? 'a href="' +
                l(n) +
                '" target="_blank" title="' +
                X.get("image" === q.modal.type ? "zoom" : "open in new tab") +
                '"'
              : "div") +
            ...
            v(!0, "modal-info-context") +
            '<div class="modal-info-name">' +
            i(n.basename) +
            '</div>\t\t\t<div class="modal-info-meta">' +
            (n.mime
              ? '<span class="modal-info-mime">' +
                P.get_svg_icon_files(n) +
                n.mime +
                "</span>"
              : "") +
            u(n.dimensions, "modal-info-dimensions") +
            f(n, "modal-info-filesize") +
            (function (e, t) {
              ...
              return e.fileperms
                ? '<span class="' +
                    ...
                    '">' +
                    P.get_svg_icon(i ? "lock_open_outline" : "lock_outline") +
                    e.fileperms +
                    "</span>"
                : "";
            ...
            P.get_svg_icon("date") +
            P.get_time(n, "llll", "LLLL", !0) +
            "</div>" +
            _(n.image, "modal-info-exif") +
            g(n.image, "modal-info", !0) +
            "</div>";
        t.classList.toggle("modal-lg", d),
          ...
          (m.innerHTML = b);
        var w,
          k = !!n.browser_image && _class("files-img-placeholder", m)[0];
        k &&
      ...
      function V(e) {
        if (!k && !r.disabled) {
          ...
          (k = !0), r.classList.add("tooltip-loading");
          var t = _c.current_dir;
          I({
            params:
              ...
              q.modal.item.path +
              "&text=" +
              encodeURIComponent(q.modal.code_mirror.getValue()),
            json_response: !0,
            fail: function () {
              M(!1, "fail"), ee.fire();
            },
            complete: function (e) {
              M(e.success, e.error),
                e.success
                  ? ($.fire(X.get("save", !0) + " " + q.modal.item.basename),
    ...
    var re = function (e, t) {
        var i,
          ...
          H = function (e) {
            32 === e.keyCode &&
              (U.is_dual_input && b.toggleControls(!1), b.setIdle(!c));
          },
          k = function (e, t, i) {
          ...
          A = function (e) {
            u !== e && (t.toggle_class(d, "svg-preloader-active", !e), (u = e));
          },
          E = [
            {
              name: "caption",
        ...
        (b.init = function () {
          ...
          t.copy_unique(e.options, C),
            ...
            (p = e.listen)("onVerticalDrag", function (e) {
              w && e < 0.95
                ? b.toggleControls()
                : !w && e >= 0.95 && b.toggleControls(!0);
            }),
            p("onPinchClose", function (e) {
              w && e < 0.9
                ? (b.toggleControls(), (n = !0))
                : n && !w && e > 0.9 && b.toggleControls(!0);
            }),
            ...
            p("doubleTap", function (t) {
              ...
              e.zoomTo(
                e.getZoomLevel() === i ? g.getDoubleTapZoom(!1, e.currItem) : i,
                t,
                250
              );
            }),
                ...
                clearTimeout(f),
                  (f = setTimeout(function () {
                    e.currItem && e.currItem.loading
                      ? e.currItem.img && !e.currItem.img.naturalWidth && A(!1)
                      : A(!0);
            ...
            g.counterEl &&
              ...
              !g.loop &&
                ...
                t.toggle_class(
                  l,
                  "pswp__element--disabled",
                  e.getCurrentIndex() === g.getNumItemsFn() - 1
                ));
          }),
              ...
              if (t.detail && "mouse" === t.detail.pointerType) {
                if (!t.detail.rightClick)
                  if (
                    ...
                    var a =
                      (g.getNumItemsFn() > 2 || !e.getCurrentIndex()) &&
                      ("next" == g.click ||
                        t.detail.releasePoint.x > q.popup.pswp.clientWidth / 2)
                        ? "next"
                        : "prev";
                    e[a]();
                  }
      ...
      pe = function (e, t, i, a) {
        ...
        var l,
            ...
            J &&
              ...
              (e &&
                (v > n.currItem.fitRatio
                  ? ve || (Wt(n.currItem, !1, !0), (ve = !0))
                  : ve && (Wt(n.currItem), (ve = !1))),
              Ce(J, se.x, se.y, v));
          },
          He = function (e) {
            e.container &&
          ...
          Ee = null,
          Ie = function () {
            Ee && (ce.unbind(document, "mousemove", Ie), Ae()),
          ...
          De = function (e) {
            e && (N || F || Q || R) && (e.preventDefault(), e.stopPropagation());
          },
          Pe = function () {
          ...
          Xe = {
              ...
              if (!l && !s) {
                ...
                for (
                  n.framework = ce,
                    ...
                    n.itemHolders = x =
                      [
                        { el: q.popup.items[0], wrap: 0, index: -1 },
                        { el: q.popup.items[1], wrap: 0, index: -1 },
                        { el: q.popup.items[2], wrap: 0, index: -1 }
                      ],
                    ...
                    f = {
                      ...
                      orientationchange: function () {
                        clearTimeout(I),
                          (I = setTimeout(function () {
                            re.x !== q.popup.scrollwrap.clientWidth &&
                              n.updateSize();
                          }, 500));
                      },
                      scroll: Pe,
                ...
                be("firstUpdate"),
                  ...
                  void 0 === A &&
                    (be("initialLayout"), (A = j = ce.getScrollY()));
                var a =
                  "pswp--open" +
                  (o.showHideOpacity ? " pswp--animate_opacity" : "") +
                  (U.is_pointer && ("zoom" == o.click || o.getNumItemsFn() < 2)
                    ? " pswp--zoom-cursor"
                    : "");
                for (
                ...
                ce.bind(q.popup.scrollwrap, u, n),
                  xe("initialZoomInEnd", function () {
                    n.setContent(x[0], c - 1),
                      ...
                      E.is_mouse
                        ? Ae()
                        : U.is_pointer && ce.bind(document, "mousemove", Ie),
            ...
            panTo: function (e, t, i) {
              i ||
                (e > K.min.x ? (e = K.min.x) : e < K.max.x && (e = K.max.x),
            ...
            goTo: function (e, t, i) {
              ...
              if ("slide" === a)
                ...
                (ue = l),
                  ...
                  (Q = !1),
                  q.popup.image_anim &&
                    !q.popup.image_anim.paused &&
                    q.popup.image_anim.pause();
                var s =
                  !!q.popup.transitions.hasOwnProperty(a) &&
                  q.popup.transitions[a](t);
                if (
                  ((q.popup.caption_transition_delay = (s && s.duration) || 0),
                  n.updateCurrItem(),
                  !s)
                )
                  return;
                ...
                r &&
                  (q.popup.image_timer
                    ? clearTimeout(q.popup.image_timer)
                    : (q.popup.image_anim = anime(
            ...
            updateCurrItem: function (e) {
              if (0 !== ue) {
                ...
                if (!(e && i < 2)) {
                  ...
                  if (J && 1 === Math.abs(ue)) {
                    var o = Ot(b);
                    o.initialZoomLevel !== v && (qt(o, re), Wt(o), He(o));
                  }
              ...
              if (
                ...
                for (var t, i, a, l = 0; l < 3; l++)
                  (t = x[l]),
                    ...
                    (a = c + l - 1),
                    o.loop && Zt() > 2 && (a = _e(a)),
                    (i = Ot(a)) && (h || i.needsUpdate || !i.bounds)
                      ? (n.cleanSlide(i),
                        n.setContent(t, a),
                        1 === l && ((n.currItem = i), n.updateCurrZoomItem(!0)),
                        (i.needsUpdate = !1))
                      : -1 === t.index && a >= 0 && n.setContent(t, a),
                    i && i.container && (qt(i, re), Wt(i), He(i));
                h = !1;
              }
              (g = v = n.currItem.initialZoomLevel),
                (K = n.currItem.bounds) &&
                  ((se.x = K.center.x), (se.y = K.center.y), Le(!0)),
                be("resize");
            },
            zoomTo: function (e, t, i, a, n) {
              ...
              i
                ? We("customZoomTo", 0, 1, i, a || ce.easing.sine.inOut, p)
                : p(1);
            }
          },
          Ye = {},
          ...
          mt = function (e, t) {
            return (
              !(!e || e === document || e === q.popup.scrollwrap) &&
          ...
          wt = function (e, t) {
            var i,
              ...
              d = lt.x - et.x;
            if (
              ((i = r > K.min[e] || r < K.max[e] ? o.panEndFriction : 1),
              (r = se[e] + t[e] * i),
              ...
              if (0 !== e)
                if (
                  ...
                  if (
                    ...
                    (oe.y += Ke.y), (se.y += Ke.y);
                    var c = _t();
                    return (R = !0), be("onVerticalDrag", c), we(c), void Le();
                  }
                  !(function (e, t, i) {
                    if (e - S > 50) {
          ...
          kt = function (e) {
            ...
            if (
              ...
              if ((Be(), O || (O = Mt()), O.calculateSwipeSpeed("x"), R)) {
                ...
                Q ||
                  ("swipe" === a ? !W && v > n.currItem.fitRatio && Vt(O) : At());
              }
          },
          Mt = function () {
            var e,
              ...
              i = {
                ...
                calculateOverBoundsAnimOffset: function (e, t) {
                  i.backAnimStarted[e] ||
                    (se[e] > K.min[e]
                      ? (i.backAnimDestination[e] = K.min[e])
                      : se[e] < K.max[e] && (i.backAnimDestination[e] = K.max[e]),
                ...
                panAnimLoop: function () {
                  if (
                    Fe.zoomPan &&
                    ((Fe.zoomPan.raf = M(i.panAnimLoop)),
                    (i.now = ye()),
          ...
          zt = function (e, t, i) {
            var a, l, s;
            if (
              ((q.popup.caption_transition_delay = 0),
              Q || (at = c),
              "swipe" === e)
            ) {
            ...
            l &&
              ((c += l) < 0
                ? ((c = o.loop ? Zt() - 1 : 0), (s = !0))
                : c >= Zt() && ((c = o.loop ? 0 : Zt() - 1), (s = !0)),
              (s && !o.loop) || ((ue += l), (pe -= l), (a = !0)));
            var p,
              d = me.x * pe,
              m = Math.abs(d - lt.x);
            return (
          ...
          Rt = function (t, i, a, l) {
                ...
                Ne("initialZoom"),
                  a
                    ? (n.template.removeAttribute("style"),
                      q.popup.bg.style.removeProperty("opacity"))
                    : (we(1),
            ...
            (m = r),
              ...
              a ||
                ...
                (se.x = s.x),
                (se.y = s.y - j),
                (q.popup[u ? "pswp" : "bg"].style.opacity = 0.001),
                Le()),
              Ue("initialZoom"),
              a && !m && e.classList.remove("pswp--animated-in"),
              u &&
                (a
                  ? ce.toggle_class(e, "pswp--animate_opacity", !m)
                  : setTimeout(function () {
              ...
              (Et = setTimeout(
                function () {
                  if ((be("initialZoom" + (a ? "Out" : "In")), a)) {
                    ...
                    m
                      ? We("initialZoom", 0, 1, p, ce.easing.cubic.out, r, d)
            ...
            setContent: function (e, t) {
              ...
              if (s) {
                ...
                if (
                  ...
                  s.src &&
                    !s.loadError &&
                    (((a = ce.createEl("pswp__img", "img")).style.opacity = 1),
                    (a.src = s.src),
                    Wt(s, a),
                    Nt(0, s, r, a));
                else {
                ...
                Tt || t !== c ? He(s) : ((J = r.style), Rt(s, a || s.img)),
                  ce.resetEl(e.el),
                  e.el.appendChild(r);
          ...
          publicMethods: {
            ...
            onTapRelease: function (e, t) {
              ...
              if (
                ...
                !P &&
                !qe &&
                (!H || q.popup.container.contains(e.target))
              ) {
                var n = t;
                if (
                  Yt &&
          ...
          ge("DesktopZoom", {
            publicMethods: {
              ...
              toggleDesktopZoom: function (t) {
                t = t || { x: re.x / 2 + de.x, y: re.y / 2 + de.y };
    ...
    function de() {
      ...
      [".modal-body", "#files"].forEach(function (t) {
        ...
        !_c.prevent_right_click &&
          _c.context_menu &&
          (N.files_container &&
            N.files_container.addEventListener("contextmenu", function (e) {
              var t = e.target.closest(".files-a");
              P.create_contextmenu(
                e,
                "files",
                t || N.files_container,
          ...
          N.sidebar_menu &&
            N.sidebar_menu.addEventListener("contextmenu", function (e) {
    ...
    !(function () {
      if (_c.menu_exists) {
        ...
        u || document.documentElement.classList.add("sidebar-closed"),
          ...
          (P.set_menu_active = function (e) {
            ...
            (c = !!i && i.firstChild) != t &&
              (t && P.menu_loading(t, !1), g(t, !1), g(c, !0));
          }),
          (N.sidebar_toggle.innerHTML = P.get_svg_icon_multi(
            "menu",
            "menu_back"
          )),
        ...
        !(
          ...
          : (N.sidebar_menu.classList.add("sidebar-spinner"),
            ...
            I({
              ...
              complete: function (e, t, i) {
                if (
                  (N.sidebar_menu.classList.remove("sidebar-spinner"),
                  delete N.sidebar_menu.dataset.title,
                  !i || !e || e.error || !Object.keys(e).length)
                )
                  return K(), void z("Error or no dirs!");
                e.localstorage
        ...
        return (
          ...
          '<li data-level="' +
            ...
            (a
              ...
              : P.get_svg_icon_class(r, "menu-icon menu-icon-folder")) +
            i(e.basename) +
            "</a>"
        );
      }
      function V(t, i) {
        ...
        if (
          ...
          U.local_storage &&
            ((N.sidebar_menu.scrollTop =
              E.get("files:interface:menu_scroll:" + _c.location_hash) || 0),
            y(
              N.sidebar_menu,
              w(function () {
                E.set(
          ...
          n.length &&
            ...
            (N.sidebar_topbar.innerHTML =
              '<button id="menu-toggle" type="button" class="btn-icon' +
              (d ? " is-expanded" : "") +
              '">' +
              P.get_svg_icon_multi("plus", "minus") +
              "</button>"),
            y(
              (e = N.sidebar_topbar.lastElementChild),
              function (e) {
                if (d) {
                  var t = [],
                    i = [],
            ...
            targets: (function () {
              for (
                var e = [],
                  t = a.children,
                  i = t.length,
                  n = N.sidebar_inner.clientHeight,
                  o = 0;
                o < i;
                o++
              ) {
          ...
          (m.delay = anime.stagger(
            O(20, 50, Math.round(200 / m.targets.length))
          )),
            anime(m);
        }
        y(a, function (e) {
                ...
                P.get_files(s.dataset.path, "push"),
                  matchMedia("(min-width: 992px)").matches
                    ? _c.menu_show ||
                      ...
                      n && (t.disabled = n),
                      setTimeout(function () {
                        t.classList.remove([i]), n && (t.disabled = !1);
                      }, o || 2e3))
                    : x();
      ...
      (function () {
        ...
        q.sort.keys.includes(t[0]) || (t[0] = "name"),
          (t[1] && ["asc", "desc"].includes(t[1])) ||
            (t[1] = q.sort.sorting[t[0]].order),
          t.join("_") !== _c.sort && (_c.sort = t.join("_")),
          e(t[0], t[1]);
        var i = _id("change-sort");
        i.innerHTML =
          '<button type="button" class="btn-icon btn-topbar">' +
          P.get_svg_icon("sort_" + q.sort.sort + "_" + q.sort.order) +
          '</button><div class="dropdown-menu dropdown-menu-topbar dropdown-menu-center"><h6 class="dropdown-header" data-lang="sort">' +
          X.get("sort") +
          "</h6>" +
          M(q.sort.keys, function (e) {
            return (
              '<button class="dropdown-item' +
              (e === q.sort.sort ? " active sort-" + q.sort.order : "") +
              '" data-action="' +
              e +
              '">' +
              P.get_svg_icon_multi("menu_down", "menu_up") +
              P.get_svg_icon_multi("sort_" + e + "_asc", "sort_" + e + "_desc") +
              '<span class="dropdown-text" data-lang="' +
              e +
              '">' +
              X.get(e) +
        ...
        function p(e, t, i) {
          var a = i ? "add" : "remove";
          e &&
            (o[q.sort.index].classList[a]("active"),
            m[q.sort.index].classList[a]("sortbar-active")),
            (e || t) &&
              (o[q.sort.index].classList[a]("sort-" + q.sort.order),
        ...
        (P.set_sort = function (t) {
          ...
          _c.debug && console.time("sort"),
            q.list.sort(q.sort.prop, { order: q.sort.order, sortFunction: l }),
            _c.debug && console.timeEnd("sort");
        }),
          P.dropdown(i, a, function () {
            P.set_sort(
              q.sort.keys[
                q.sort.index >= q.sort.keys.length - 1 ? 0 : q.sort.index + 1
              ]
            );
          }),
          d(n, P.set_sort),
          ...
          (N.sortbar.innerHTML =
            ...
            M(q.sort.keys, function (e) {
              return (
                ...
                e +
                (e === q.sort.sort
                  ? " sortbar-active sort-" + q.sort.order
                  : "") +
                '" data-action="' +
                e +
                '"><span data-lang="' +
      ...
      (function () {
        if (
          ((N.topbar_top = _id("topbar-top")),
          (q.topbar = { info: {} }),
          (N.filter.placeholder = X.get("filter")),
          (N.filter.title = U.c_key + "F"),
          oe.hash(),
          N.filter.parentElement.insertAdjacentHTML(
            "beforeend",
            P.get_svg_icon("search")
          ),
          X.dropdown(),
          _c.has_login)
        ) {
        ...
        screenfull.isEnabled &&
          ...
          (P.topbar_info_search = function (e, t) {
            ...
            N.topbar_info.classList.contains("info-search")
              ? (N.topbar_info.classList.toggle("info-nomatch", !t),
                (N.topbar_info.children[0].textContent = t),
                (N.topbar_info.children[2].textContent = e))
              : P.topbar_info(
                  '<span class="info-search-count">' +
                    t +
                    '</span><span class="info-search-lang"><span data-lang="matches found for">' +
                    X.get("matches found for") +
      ...
      "intersectionRatio" in window.IntersectionObserverEntry.prototype
        ? de()
        : P.load_plugin("intersection-observer", de, {
